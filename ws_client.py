...
class WsClient:
    ...
    def __init__(self, url, judger_name, task_scheduler, fetcher, builder, 
                 cr_sender, judger, reporter, game_host_image_tag):
        self._url = url
    ...
    def on_message(self, ws, message):
        ...
        if type == "compilation_task":
            ...
            asyncio.run(self._task_scheduler.schedule(JudgeTask(match_id,
                                                        player_code_ids,
    ...
    async def start(self):
        ...
        self._keep_request_judge_task = asyncio.create_task(self.keep_request_judge_task()) 
        
        self._keep_report_finished_judge_task = asyncio.create_task(self.keep_report_finished_judge_task())
